...
One string caught my attention: a reference to `iqvw64e.sys` — the [Intel Network Adapter Diagnostic Driver](https://www.loldrivers.io/drivers/e2a8b826-d997-4a35-a56e-ac87b9da79f7/), a known vulnerable signed driver that's been abused in [BYOVD attacks](https://attack.mitre.org/techniques/T1068/) to kill anticheat and EDR processes from kernel level. The reference is likely a defensive check — detecting whether someone has loaded it — but its presence indicates the AC is aware of this attack vector.
